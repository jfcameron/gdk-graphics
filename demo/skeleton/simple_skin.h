...
#ifndef GDK_DEMO_SIMPLE_SKIN_H
#define GDK_DEMO_SIMPLE_SKIN_H

#include <string_view>

/// \file Khronos glTF-Sample-Assets "SimpleSkin"
/// model by Marco Hutter (https://github.com/javagl/), CC0 1.0 Universal
namespace demo {
    inline constexpr std::string_view SIMPLE_SKIN_GLTF = R"gltf({
  "scene" : 0,
  "scenes" : [ {
    "nodes" : [ 0, 1 ]
  } ],
