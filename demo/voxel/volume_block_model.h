...
#ifndef GDK_GFX_EXT_VOLUMETRIC_BLOCK_H
#define GDK_GFX_EXT_VOLUMETRIC_BLOCK_H
...
namespace gdk::ext::volume {
    ...
    using per_voxel_generator_type = std::function<graphics::model_data/*returns model data for the current voxel*/(
    ...
    graphics::model_data make_per_voxel_model_data(const volumetric_data_view<data_type, size_x, size_y, size_z> aData, 
        per_voxel_generator_type<data_type> aVisitor,
        const std::optional<const volumetric_data_view<data_type, size_x, size_y, size_z>> aNorthNeighbouringDataVolume = {},
        const std::optional<const volumetric_data_view<data_type, size_x, size_y, size_z>> aSouthNeighbouringDataVolume = {},
        const std::optional<const volumetric_data_view<data_type, size_x, size_y, size_z>> aEastNeighbouringDataVolume = {},
        const std::optional<const volumetric_data_view<data_type, size_x, size_y, size_z>> aWestNeighbouringDataVolume = {},
        const std::optional<const volumetric_data_view<data_type, size_x, size_y, size_z>> aTopNeighbouringDataVolume = {},
        const std::optional<const volumetric_data_view<data_type, size_x, size_y, size_z>> aBottomNeighbouringDataVolume = {}) { 
        graphics::model_data output;
    ...
    using optimized_block_face_generator_type = std::function<graphics::model_data/*returns graphics::model_data for the surface at a given position & direction*/(
        const graphics::floating_point_type/*origin of the optimized surface in the x axis*/, 
        const graphics::floating_point_type/*origin of the optimized surface in the y axis*/, 
        const graphics::floating_point_type/*origin of the optimized surface in the z axis*/, 
        const graphics::floating_point_type/*width of the optimized surface*/, 
        const graphics::floating_point_type/*length of the optimized surface*/)>;
    ...
    ///
    template<typename data_type, data_type data_type_empty_value, size_t size_x, size_t size_y, size_t size_z>
    graphics::model_data make_optimized_block_model_data(const volumetric_data_view<data_type, size_x, size_y, size_z> aData, 
        ...
        gdk::graphics::model_data buffer;
            ...
            for (size_t y = 0; y < size_y; ++y) {
                for (size_t x = 0; x < size_x; ) {
                    ...
                    buffer += aNorthFaceGenerator(
                        static_cast<graphics::floating_point_type>(x),
                        static_cast<graphics::floating_point_type>(y),
                        static_cast<graphics::floating_point_type>(z),
                        static_cast<graphics::floating_point_type>(w),
                        static_cast<graphics::floating_point_type>(h));
                    x += w;
                }
            }
        }
