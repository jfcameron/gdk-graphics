...
namespace gdk {
    ...
    public:
        ...
        bool try_set_uniform(const std::string &aName, const graphics_mat2x2_type &avalue) const; 
        //! assign a mat2x2 uniform array from a vector of mat2x2s
        bool try_set_uniform(const std::string &aName, const std::vector<graphics_mat2x2_type> &avalue) const; 

        //! assign a mat3x3 uniform from a mat3x3
        bool try_set_uniform(const std::string &aName, const graphics_mat3x3_type &avalue) const; 
        ...
        //bool try_set_uniform(const std::string &aName, const gdk::texture &aTexture) const;
