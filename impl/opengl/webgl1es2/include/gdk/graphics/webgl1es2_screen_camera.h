...
namespace gdk::graphics {
    ...
    //
        ...
        virtual void set_clear_mode(const gdk::graphics::camera::clear_mode aClearMode) override;
    ///@}
    ...
    //
        ...
        void activate(const gdk::graphics::intvector2_type& aFrameBufferSize) const;
    ///@}
