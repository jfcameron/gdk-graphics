...
void webgl1es2_texture_camera::set_projection(const gdk::graphics_matrix4x4_type &aMatrix) {
...
void webgl1es2_texture_camera::set_transform(const gdk::graphics_matrix4x4_type &aMatrix) {
