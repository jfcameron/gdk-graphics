...
batch_modeler::batch_modeler(context_ptr_type aGraphics, material_ptr_type aMaterial)
: m_pMaterial(aMaterial)
, m_pModel(aGraphics->make_model())
{}

const_model_ptr_type batch_modeler::model() const { return m_pModel; }

const_material_ptr_type batch_modeler::material() const { return m_pMaterial; }
