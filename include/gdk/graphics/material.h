...
namespace gdk::graphics {
    ...
    public:
        ...
        using texture_ptr_type = std::shared_ptr<gdk::graphics::texture>;
        ...
        //! \brief assign an RGBA colour to a vec4 uniform
        ...
        virtual void set_int_vector2_array(const std::string_view aName, const std::vector<intvector2_type> &aValue) = 0;
